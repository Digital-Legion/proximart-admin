...
import { faCopyright, faPlus, faSave, faBan, faEdit, faTrash, faSitemap, faCubes, faBold, faPalette, faUserCircle, faEye, faEyeSlash, faPager, faClipboardList } from '@fortawesome/free-solid-svg-icons'
...
library.add(faCopyright, faPlus, faSave, faBan, faEdit, faTrash, faSitemap, faCubes, faCuttlefish, faBold, faPalette, faUserCircle, faProductHunt, faClipboardList, faEye, faEyeSlash, faDochub, faPager)
