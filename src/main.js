...
import { faCopyright, faPlus, faSave, faBan, faEdit, faTrash, faSitemap, faCubes, faBold, faPalette, faUserCircle, faEye, faEyeSlash, faPager } from '@fortawesome/free-solid-svg-icons'
...
library.add(faCopyright, faPlus, faSave, faBan, faEdit, faTrash, faSitemap, faCubes, faCuttlefish, faBold, faPalette, faUserCircle, faProductHunt, faEye, faEyeSlash, faDochub, faPager)
